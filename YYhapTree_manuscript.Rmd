...
if("bb4" %in% names(HapTable) && !is.null(HapTable[["bb4"]])) {
  h=HapTable[["bb4"]]
  kable(inVertex(profs[["bb4"]],m3), caption="Haplogroup bb4 population distribution")
}
```
...
if("baaa4aa1" %in% names(HapTable) && !is.null(HapTable[["baaa4aa1"]])) {
  h=HapTable[["baaa4aa1"]]
  kable(inVertex(profs[["baaa4aa1"]],m3), caption="Haplogroup baaa4aa1 population distribution")
}
```
