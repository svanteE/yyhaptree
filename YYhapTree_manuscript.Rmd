...
```{r bb4-dend, echo=FALSE, fig.cap="Dendrogram of haplogroup bb4 (Q - South American)", fig.width=7, fig.height=4}
if("bb4" %in% names(HapTable) && !is.null(HapTable[["bb4"]])) {
  ...
  if(nrow(h) >= 2) {
    ...
    legend("topright", inset = c(-0.15, 0), legend = group_levels, fill = colors[1:length(group_levels)], title = "Population", cex=.7, bty="n")
...
```{r baaa4aa1-dend, echo=FALSE, fig.cap="Dendrogram of haplogroup baaa4aa1 (R1b - Western European)", fig.width=7, fig.height=4}
