...
Traditional Y-chromosome phylogenetic approaches typically proceed through marker discovery, followed by tree construction using parsimony, maximum likelihood, or Bayesian methods (Jobling and Tyler-Smith 2003; Poznik et al. 2016). These methods require a priori identification of informative SNPs and assumptions about mutation models and branching processes. In contrast, the yyhap framework directly exploits the linkage structure inherent in non-recombining regions to identify nested haplotype sets that automatically define phylogenetic relationships.
...
We have developed and validated the yin-yang haplotype framework for Y-chromosome phylogenetic reconstruction, demonstrating that haplotype structure directly encodes phylogenetic relationships in non-recombining genomic regions. Applied to 1,223 males from the 1000 Genomes Project, our approach identified 171 yyhaps covering 90.4% of high-quality SNPs, forming a hierarchical tree strongly concordant with established haplogroup classifications while revealing fine-scale population structure.
